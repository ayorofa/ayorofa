  ...
  return (
    <main className="sec">
      <div className="wrap prose">
        ...
        <h2>Cookies</h2>
        <p>Des cookies sont utilisés pour la mesure d’audience et la publicité. Vous pouvez les gérer via le bandeau de consentement.</p>
        <p className="muted sm" style={{ marginTop: 24 }}>Modèle informatif — à faire vérifier par un professionnel avant mise en ligne.</p>
      </div>
    </main>
  );
}
